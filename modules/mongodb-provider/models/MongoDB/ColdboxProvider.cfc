...
*/
component name="MongoDBColdboxProvider" serializable="false" extends="Provider" implements="coldbox.system.cache.IColdboxApplicationCache" accessors=true{
	...
	*/
	function init() output=false{
		...
		// Cache Prefixes
		this.VIEW_CACHEKEY_PREFIX 	= "MongoDB_view-";
		this.EVENT_CACHEKEY_PREFIX 	= "MongoDB_event-";
	...
	/**
	* Clear all events
	* TODO: Change this to use MongoDB view based on metastats
	*/
